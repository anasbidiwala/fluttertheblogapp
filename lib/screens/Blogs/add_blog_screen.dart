  ...
  void initState() {
    ...
    if(widget.addBlogScreenMode==AddBlogScreenMode.EDIT)
    {
      ...
      _controller = quill.QuillController(
          document: quill.Document.fromJson(jsonDecode(widget.singleBlog!.blogDesc)),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              border: Border.all(color: appModel.primaryColorDark)
                            ),
                                ...
                                if(_formKey.currentState!.validate())
                                {
                                  if(widget.addBlogScreenMode == AddBlogScreenMode.ADD)
                                  {
                                    if(image==null)
                                    {
                                      ...
                                      params["blogDesc"] = jsonEncode(_controller.document.toDelta().toJson());
                                      params["blogDescPlainText"] = _controller.document.toPlainText().toString().trim().replaceAll("\n", " ");
