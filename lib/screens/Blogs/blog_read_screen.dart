...
class BlogReadScreen extends StatefulWidget {
  ...
  const BlogReadScreen({Key? key,this.singleBlog, this.isFromNotification = false, this.blogId}) : super(key: key);
  ...
  void initState() {
    ...
    if(widget.isFromNotification)
    {
      ...
      _controller = quill.QuillController(
          document: quill.Document.fromJson(jsonDecode(singleBlog!.blogDesc)),
